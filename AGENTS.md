...
- 修改知识流水线必须运行 `test_rag_processor.py`、`test_rag_pipeline.py`、`test_rag_pipeline_execute.py`、`test_rag_retrieval_v2.py`、RAG integration 和 workflow citation 回归，并重建 Docker 做 Processor、双索引、混合检索、Rerank 与版本切换验收。
